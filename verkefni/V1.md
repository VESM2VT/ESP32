...
1. Lestu þér til um [TB6612FNG H-Bridge](https://dronebotworkshop.com/tb6612fng-h-bridge/) (lestu að kaflanum *TB6612FNG with Arduino*) og [PWM](https://github.com/VESM2VT/ESP32/blob/main/kennsluefni/analog.md#unni%C3%B0-me%C3%B0-hli%C3%B0r%C3%A6n-gildi-%C3%AD-esp32).
...
> [!CAUTION]
> Passaðu að tengja **VM** í batterípack (aflgjafa) annars er hætta á því að ESP32-S3 eyðileggist. <br>
> Passaðu að tengja **VCC** í 3.3V en **ekki** 5V annars er hætta á því að þú eyðileggir TB6612FNG H-Bridge.
...
1. Keyra áfram á hraðnum 1000 í eina sekúndu. Stoppa í hálfa sekúndu.
1. Beygja til hægri (90°). Stoppa í hálfa sekúndu.
1. Keyra áfram á hraðanum 700 í eina sekúndu. Stoppa í hálfa sekúndu.
1. Beygja til hægri (90°). Stoppa í hálfa sekúndu.
1. Keyra áfram á hraðanum 1000 í eina sekúndu. Stoppa í hálfa sekúndu.
1. Beygja til vinstri (90°). Stoppa í hálfa sekúndu.
1. Bakka á hraðanum 700 í eina sekúndu. Stoppa í hálfa sekúndu.
1. Beygja til vinstri (90°). Stoppa í hálfa sekúndu.

<img src="https://github.com/VESM2VT/ESP32/blob/main/myndir/Fyrirframa%CC%81kve%C3%B0inlei%C3%B0.png" width="50%" height="50%">
